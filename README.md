...
```kotlin
dependencies {
    implementation("com.github.kmatsushita1012:mapkit-android:v0.4.8")
}
```
...
```kotlin
dependencies {
    implementation("com.github.kmatsushita1012.mapkit-android:mapkit-core:v0.4.8")
    implementation("com.github.kmatsushita1012.mapkit-android:mapkit-webview:v0.4.8")
    implementation("com.github.kmatsushita1012.mapkit-android:mapkit-compose:v0.4.8")
}
```
