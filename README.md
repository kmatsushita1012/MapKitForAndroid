...
```kotlin
dependencies {
    implementation("com.github.kmatsushita1012:mapkit-for-android:v0.2.1")
}
```
...
```kotlin
dependencies {
    implementation("com.github.kmatsushita1012.mapkit-for-android:mapkit-core:v0.2.1")
    implementation("com.github.kmatsushita1012.mapkit-for-android:mapkit-webview:v0.2.1")
    implementation("com.github.kmatsushita1012.mapkit-for-android:mapkit-compose:v0.2.1")
}
```
